    ...
    if game_state == "Menu":
        ...
        if pygame.font:
            message_display(
                ...
                "Icy Tower(clone)",
                0,
                MENU_START_Y + round(SCREEN_HEIGHT * 0.15),
                60,
                white,
                True,
            )
            message_display(
                ...
                "Play",
                0,
                MENU_START_Y + round(SCREEN_HEIGHT * 0.30),
                50,
                white,
                True,
            )
            message_display(
                ...
                "About",
                0,
                MENU_START_Y + round(SCREEN_HEIGHT * 0.40),
                50,
                white,
                True,
            )
            message_display(
                ...
                "Quit",
                0,
                MENU_START_Y + round(SCREEN_HEIGHT * 0.50),
                50,
                white,
                True,
            )
